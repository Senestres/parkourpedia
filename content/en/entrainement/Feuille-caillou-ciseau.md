...
When a player reaches the opponent's base, they score a point for their team. The game continues immediately, with both teams sending another player.
Play one round against the clock, then the teams switch sides for the second round.
...
![Diagram of the game of RPS in a school gym](/img/FCC.png)
